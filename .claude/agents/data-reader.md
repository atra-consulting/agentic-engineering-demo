...
Read the root `CLAUDE.md` first. This is a Node.js/TypeScript + Angular CRM application; skills live under `.claude/skills/<name>/`, subagents under `.claude/agents/<name>.md`.
